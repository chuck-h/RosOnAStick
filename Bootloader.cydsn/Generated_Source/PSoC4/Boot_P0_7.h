...
#define Boot_P0_7_DM_ALG_HIZ         (0x00u << Boot_P0_7_DRIVE_MODE_SHIFT)
#define Boot_P0_7_DM_DIG_HIZ         (0x01u << Boot_P0_7_DRIVE_MODE_SHIFT)
#define Boot_P0_7_DM_RES_UP          (0x02u << Boot_P0_7_DRIVE_MODE_SHIFT)
#define Boot_P0_7_DM_RES_DWN         (0x03u << Boot_P0_7_DRIVE_MODE_SHIFT)
#define Boot_P0_7_DM_OD_LO           (0x04u << Boot_P0_7_DRIVE_MODE_SHIFT)
#define Boot_P0_7_DM_OD_HI           (0x05u << Boot_P0_7_DRIVE_MODE_SHIFT)
#define Boot_P0_7_DM_STRONG          (0x06u << Boot_P0_7_DRIVE_MODE_SHIFT)
#define Boot_P0_7_DM_RES_UPDWN       (0x07u << Boot_P0_7_DRIVE_MODE_SHIFT)
