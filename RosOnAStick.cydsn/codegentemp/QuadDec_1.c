...
void QuadDec_1_Init(void)
{
    ...
    /* Set other values from customizer */
        ...
        #if (QuadDec_1__COUNT_DOWN == QuadDec_1_TC_COUNTER_MODE)
            QuadDec_1_WriteCounter(QuadDec_1_TC_PERIOD_VALUE );
        #endif  /* (QuadDec_1__COUNT_DOWN == QuadDec_1_TC_COUNTER_MODE) */
        ...
        /* Set values from customizer to CTRL2 */
            ...
            QuadDec_1_TRIG_CONTROL2_REG =
                ...
                QuadDec_1_WriteCounter(QuadDec_1_PWM_PERIOD_VALUE);
...
*
* Summary:
*  Initializes the QuadDec_1 with default customizer
...
*  calls to the QuadDec_1_Start() routine.
*
*******************************************************************************/
...
*  QuadDec_1 operates in the continuous mode.
*
* Parameters:
*  oneShotEnable
*   Values:
...
{
    #if (QuadDec_1_CY_TCPWM_V2)
        uint32 currentMode;
    #endif /* (QuadDec_1_CY_TCPWM_V2) */

    #if (QuadDec_1_CY_TCPWM_V2)
        currentMode = ((QuadDec_1_CONTROL_REG & QuadDec_1_UPDOWN_MASK) >> QuadDec_1_UPDOWN_SHIFT);

        if (QuadDec_1__COUNT_DOWN == currentMode)
        {
            QuadDec_1_COMP_CAP_REG = ((compare + 1u) & QuadDec_1_16BIT_MASK);
        }
        else if (QuadDec_1__COUNT_UP == currentMode)
        {
            QuadDec_1_COMP_CAP_REG = ((compare - 1u) & QuadDec_1_16BIT_MASK);
        }
        else
...
uint32 QuadDec_1_ReadCompare(void)
{
        ...
        if (QuadDec_1__COUNT_DOWN == currentMode)
        {
            regVal = ((QuadDec_1_COMP_CAP_REG - 1u) & QuadDec_1_16BIT_MASK);
        }
        else if (QuadDec_1__COUNT_UP == currentMode)
        {
            regVal = ((QuadDec_1_COMP_CAP_REG + 1u) & QuadDec_1_16BIT_MASK);
        ...
        {
            regVal = (QuadDec_1_COMP_CAP_REG & QuadDec_1_16BIT_MASK);
        }
        return (regVal);
    #else
...
void QuadDec_1_WriteCompareBuf(uint32 compareBuf)
{
        ...
        if (QuadDec_1__COUNT_DOWN == currentMode)
        {
            QuadDec_1_COMP_CAP_BUF_REG = ((compareBuf + 1u) & QuadDec_1_16BIT_MASK);
        }
        else if (QuadDec_1__COUNT_UP == currentMode)
        {
            QuadDec_1_COMP_CAP_BUF_REG = ((compareBuf - 1u) & QuadDec_1_16BIT_MASK);
...
uint32 QuadDec_1_ReadCompareBuf(void)
{
        ...
        if (QuadDec_1__COUNT_DOWN == currentMode)
        {
            regVal = ((QuadDec_1_COMP_CAP_BUF_REG - 1u) & QuadDec_1_16BIT_MASK);
        }
        else if (QuadDec_1__COUNT_UP == currentMode)
        {
            regVal = ((QuadDec_1_COMP_CAP_BUF_REG + 1u) & QuadDec_1_16BIT_MASK);
        ...
        {
            regVal = (QuadDec_1_COMP_CAP_BUF_REG & QuadDec_1_16BIT_MASK);
        }
        return (regVal);
    #else
