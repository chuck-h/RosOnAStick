/*******************************************************************************
* File Name: ROSSerial_UART_UART_BOOT.c
* Version 1.20
*
* Description:
...
/*******************************************************************************
* Function Name: ROSSerial_UART_UartCyBtldrCommStart
********************************************************************************
*
* Summary:
...
/*******************************************************************************
* Function Name: ROSSerial_UART_UartCyBtldrCommStop
********************************************************************************
*
* Summary:
*  This function does nothing.
...
/*******************************************************************************
* Function Name: ROSSerial_UART_UartCyBtldrCommReset
********************************************************************************
*
* Summary:
*  This function does nothing.
...
/*******************************************************************************
* Function Name: ROSSerial_UART_UartCyBtldrCommRead
********************************************************************************
*
* Summary:
*  This function does nothing.
...
/*******************************************************************************
* Function Name: ROSSerial_UART_UartCyBtldrCommWrite
********************************************************************************
*
* Summary:
*  This function does nothing.
