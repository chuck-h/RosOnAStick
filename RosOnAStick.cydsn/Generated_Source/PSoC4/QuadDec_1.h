...
#define QuadDec_1_CY_TCPWM_V2                    (CYIPBLOCK_m0s8tcpwm_VERSION == 2u)
...
/* Quad Mode */
/* Parameters */
#define QuadDec_1_QUAD_ENCODING_MODES            (2lu)
...
/* Interrupt Mask */
#define QuadDec_1_QUAD_INTERRUPT_MASK            (0lu)
...
/* Trigger modes */
#define QuadDec_1_TRIG_RISING                    ((uint32)QuadDec_1__TRIG_RISING)
#define QuadDec_1_TRIG_FALLING                   ((uint32)QuadDec_1__TRIG_FALLING)
#define QuadDec_1_TRIG_BOTH                      ((uint32)QuadDec_1__TRIG_BOTH)
#define QuadDec_1_TRIG_LEVEL                     ((uint32)QuadDec_1__TRIG_LEVEL)

/* Interrupt mask */
#define QuadDec_1_INTR_MASK_TC                   ((uint32)QuadDec_1__INTR_MASK_TC)
#define QuadDec_1_INTR_MASK_CC_MATCH             ((uint32)QuadDec_1__INTR_MASK_CC_MATCH)
